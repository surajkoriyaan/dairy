    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 formdiv">
          ...
          <p style="text-align:center">interested ? Sign up now </p>
<p id="abc"></p>
...
<center>
<button type="button" class="btn btn-success" onclick="fun();" style="margin-top:10px;">Sign Up</button>
</center>
<center>
<a href="login.php" style="margin-top:20px;">Sign in</a>
</center>
          </form>
        </div>
      </div>
